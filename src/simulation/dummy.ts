...
export const Simpleton = (): AgentTemplate => {
  ...
  return {
    ...
    tree: [
      ...
      { id: ids[4], type: 'action', command: 'drop', x: 27, y: 300 },
      {
        id: ids[6],
        type: 'decision',
      ...
      { id: ids[5], type: 'action', command: 'pickUp', x: 593, y: 300 },
      { id: ids[7], type: 'action', command: 'move', x: 254, y: 500 },
      { id: ids[8], type: 'action', command: 'turnLeft', x: 503, y: 500 },
    ],
  };
};
